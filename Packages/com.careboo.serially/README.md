...
<root>
  ...
  ├── Editor
  │   ├── Jasonboukheir.Serially.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Jasonboukheir.Serially.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Jasonboukheir.Serially.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Jasonboukheir.Serially.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Jasonboukheir.Serially`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Serially Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Jasonboukheir.Serially.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Jasonboukheir.Serially.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Jasonboukheir.Serially.Editor.Tests.asmdef`

  `Tests/Runtime/Jasonboukheir.Serially.Tests.asmdef`
...
Use the `Documentations~/Serially.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
